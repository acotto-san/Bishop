#language: es
Característica: accion de vencimiento en cola no finaliza casos de chat
    ...
    Antecedentes:
        ...
        Escenario: caso de chat sin interaccion es notificado por incumplimiento de vencimiento en cola y es finalizado
        ...
        Esquema del escenario: caso de chat con interacciones es notificado por incumplimiento de vencimiento en cola y es finalizado
