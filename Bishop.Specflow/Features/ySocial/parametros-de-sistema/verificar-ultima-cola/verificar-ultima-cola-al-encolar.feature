...
Característica:  Verificar ultima cola al encolar
    Como supervisor
    Quiero configurar a nivel global que los mensajes se encolen en la cola de la ultima gestionó
    ...
    Regla: solamente se van a encolar en otra cola diferente a la default los mensajes que sean de un caso ya abierto y que su ultima atencion haya sido en otra cola
        Antecedentes:
            Dado que en la configuracion de casos se tiene habilitado "Verificar última cola"
            Y que el servicio "Itchy and Scratchy Messenger" posee configurada "Cola A" como cola default
