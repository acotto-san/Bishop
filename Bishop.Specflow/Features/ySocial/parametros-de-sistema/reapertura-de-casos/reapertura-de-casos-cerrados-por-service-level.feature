#language: es
Característica: reabrir casos cerrados por service level 
    Como supervisor 
    Quiero habilitar la reapertura de casos cerrados por accion de service level
    ...
    Antecedentes:
        Dado que en parametros del sistema se encuentran las siguientes configuraciones:
            ...
            | reapertura de casos cerrados por service level | habilitado |
