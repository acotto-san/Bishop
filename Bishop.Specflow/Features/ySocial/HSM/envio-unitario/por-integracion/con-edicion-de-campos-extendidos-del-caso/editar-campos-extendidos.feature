...
Característica: editar campos extendidos al enviar un masivo de hsm desde la web del supervisor
    ...
    Objeto de ejemplo con valores válidos en cada campo:
...
Antecedentes:
  Dado que en parametros de sistema hay configurados los siguientes campos extendidos de caso:
    ...
    | pagoRealizado    | se realizo un pago    | si/no        | true o false                                       |
  ...
  Regla: se puede sobreescribir todos los campos utilizando un 1 como accion
    ...
    Escenario: se sobreescriben todos los campos de un caso con nueva data passed
    ...
    Escenario: se sobreescriben todos los campos de un caso algunos quedan vacios passed
      Dado que el usuario 1511111111 tiene un caso abierto con los siguientes datos
        |atributo             |valor            |
        |nro de caso          |33456            |  
        |nombresDelUsr        |'cosme fulanito' |
    ...
    Escenario: se agrega dato a un campo que esta vacio passed
      Dado que el usuario 1511111111 tiene un caso abierto con los siguientes datos
        |atributo             |valor            |
        |nro de caso          |33456            |  
